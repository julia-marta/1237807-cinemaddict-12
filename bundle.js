...
class Api {
  ...
  updateMovie(movie) {
    return this._load({
      url: `movies/${movie.id}`,
      method: PUT,
      body: JSON.stringify(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(movie)),
  ...
  addComment(comment, filmID) {
    return this._load({
      ...
      .then(Api.toJSON)
      .then((response) => response.comments.map(_model_comments_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  getMovies() {
    if (Provider.isOnline()) {
      return this._api.getMovies()
        .then((movies) => {
          const items = createStoreStructure(movies.map(_model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
  ...
  updateMovie(movie) {
    if (Provider.isOnline()) {
      return this._api.updateMovie(movie)
        .then((updatedMovie) => {
          this._store.setItem(updatedMovie.id, _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedMovie));
          return updatedMovie;
        });
    }

    this._store.setItem(movie.id, _model_movies_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(Object.assign({}, movie)));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: EMOJIS, Mode, UserAction, UpdateType, NavigationMode, MenuItem, SortType, FilmsType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FilmsType", function() { return FilmsType; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_total_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/total.js */ "./src/view/total.js");
/* harmony import */ var _presenter_profile_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/profile.js */ "./src/presenter/profile.js");
...
/* harmony import */ var _presenter_navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/navigation.js */ "./src/presenter/navigation.js");
...
const {INIT} = _const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"];
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_9__["default"](SERVER_NAME, AUTHORIZATION);
...
const profilePresenter = new _presenter_profile_js__WEBPACK_IMPORTED_MODULE_1__["default"](header, moviesModel);
const movieListPresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]({movieListContainer: main, moviesModel, commentsModel, filterModel, apiWithProvider, api});
const navigationPresenter = new _presenter_navigation_js__WEBPACK_IMPORTED_MODULE_3__["default"](main, filterModel, moviesModel, movieListPresenter);
...
apiWithProvider.getMovies()
  ...
  .then((allcomments) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(footer.lastElementChild, new _view_total_js__WEBPACK_IMPORTED_MODULE_0__["default"](moviesModel.getMovies()));
  })
  .catch(() => {
...
class Comments extends _observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._comments = [];
  }
...
const {ALL} = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"];

class Filter extends _observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class Movies extends _observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._movies = [];
  }
...
const {DELETE} = _const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"];
...
class Comment {
  ...
  init(comment) {
    ...
    this._commentComponent = new _view_comment_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._comment);
    this._commentComponent.setDeleteClickHandler(this._handleDeleteClick);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._commentsContainer, this._commentComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._commentComponent);
  }
...
/* harmony import */ var _view_pop_up_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/pop-up.js */ "./src/view/pop-up.js");
/* harmony import */ var _presenter_comment_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../presenter/comment.js */ "./src/presenter/comment.js");
...
const {DEFAULT, POPUP} = _const_js__WEBPACK_IMPORTED_MODULE_4__["Mode"];
const {ADD} = _const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"];
const {PATCH, MINOR} = _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"];
...
class Film {
  ...
  init(film) {
    ...
    this._filmCardComponent = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](film);
    this._popUpComponent = new _view_pop_up_js__WEBPACK_IMPORTED_MODULE_1__["default"](film, this._emoji, this._newComment, this._handlePopUpCommentsRender);
    ...
    if (prevFilmCardComponent === null || prevPopUpComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._filmContainer, this._filmCardComponent);
      return;
    }

    if (this._mode === DEFAULT || this._mode === POPUP) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(prevFilmCardComponent, this._filmCardComponent);
    }

    if (this._mode === POPUP) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(prevPopUpComponent, this._popUpComponent);
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevFilmCardComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevPopUpComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._filmCardComponent);
  ...
  _openPopUp() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._popUpContainer, this._popUpComponent);
  ...
  _handlePopUpCommentsRender(container) {
    ...
    const commentPresenter = new _presenter_comment_js__WEBPACK_IMPORTED_MODULE_2__["default"](container, this._film.id, this._changeComment);
  ...
  _handleShortcutKeysDown(container, newComment) {
    const newCommentPresenter = new _presenter_comment_js__WEBPACK_IMPORTED_MODULE_2__["default"](container, this._film.id, this._changeComment);
...
/* harmony import */ var _view_no_movies_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/no-movies.js */ "./src/view/no-movies.js");
/* harmony import */ var _view_all_movies_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/all-movies.js */ "./src/view/all-movies.js");
...
/* harmony import */ var _view_films_list_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/films-list.js */ "./src/view/films-list.js");
/* harmony import */ var _view_show_button_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../view/show-button.js */ "./src/view/show-button.js");
...
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
/* harmony import */ var _utils_sorting_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/sorting.js */ "./src/utils/sorting.js");
...
const {AFTERBEGIN, BEFORE} = _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"];
const {DEFAULT, DATE, RATING} = _const_js__WEBPACK_IMPORTED_MODULE_13__["SortType"];
const {ALL, RATED, COMMENTED} = _const_js__WEBPACK_IMPORTED_MODULE_13__["FilmsType"];
const {ADD, DELETE} = _const_js__WEBPACK_IMPORTED_MODULE_13__["UserAction"];
const {PATCH, MINOR, MAJOR, INIT} = _const_js__WEBPACK_IMPORTED_MODULE_13__["UpdateType"];
...
class MovieList {
  constructor({movieListContainer, moviesModel, commentsModel, filterModel, apiWithProvider, api} = {}) {
    ...
    this._sortingComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._movieListComponent = new _view_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noMoviesComponent = new _view_no_movies_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._allMoviesComponent = new _view_all_movies_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._topRatedComponent = new _view_top_rated_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
    this._mostCommentedComponent = new _view_most_commented_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._allMoviesListComponent = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._topRatedListComponent = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._mostCommentedListComponent = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
  ...
  init() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListContainer, this._movieListComponent);
  ...
  destroy() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._movieListComponent);
  ...
  _getFilms() {
    ...
    const filteredFilms = films.filter((film) => _utils_filter_js__WEBPACK_IMPORTED_MODULE_11__["filterRules"][currentFilter](film));

    switch (this._currentSortType) {
      case DATE:
        return Object(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_12__["sortByDate"])(filteredFilms.slice());
      case RATING:
        return Object(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_12__["sortByRating"])(filteredFilms.slice());
      default:
  ...
  _getTopRatedFilms() {
    return Object(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_12__["sortByRating"])(this._moviesModel.getMovies().slice());
  }

  _getMostCommentedFilms() {
    return Object(_utils_sorting_js__WEBPACK_IMPORTED_MODULE_12__["sortByCommentsCount"])(this._moviesModel.getMovies().slice());
  }
  ...
  _renderSorting() {
    ...
    this._sortingComponent = new _view_sorting_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._currentSortType);
    this._sortingComponent.setSortTypeChangeHandler(this._handleSortTypeChange);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListContainer, this._sortingComponent, BEFORE, this._movieListComponent);
  }

  _renderFilmCard(container, film, type) {
    const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_0__["default"](container, this._handleViewAction, this._handleCommentsViewAction, this._handleModeChange, this._commentsModel);
  ...
  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListComponent, this._loadingComponent, AFTERBEGIN);
  }

  _renderNoMovies() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListComponent, this._noMoviesComponent, AFTERBEGIN);
  }
  ...
  _renderAllMoviesList() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._allMoviesComponent, this._allMoviesListComponent);
  ...
  _renderTopRatedList() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._topRatedComponent, this._topRatedListComponent);
  }
  ...
  _renderMostCommentedList() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._mostCommentedComponent, this._mostCommentedListComponent);
  }
  ...
  _handleShowButtonClick() {
    ...
    if (this._renderedFilmsCount >= filmsCount) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._showButtonComponent);
    }
  }
  ...
  _renderShowButton() {
    ...
    this._showButtonComponent = new _view_show_button_js__WEBPACK_IMPORTED_MODULE_9__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._allMoviesComponent, this._showButtonComponent);
    this._showButtonComponent.setShowButtonClickHandler(this._handleShowButtonClick);
  }

  _renderAllMovies() {
    this._renderAllMoviesList();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListComponent, this._allMoviesComponent);
  }

  _renderTopRated() {
    this._renderTopRatedList();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListComponent, this._topRatedComponent);
  }

  _renderMostCommented() {
    this._renderMostCommentedList();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._movieListComponent, this._mostCommentedComponent);
  }
  ...
  _clearMovieList({resetAllMoviesOnly = false, resetRenderedFilmsCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._sortingComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._showButtonComponent);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._noMoviesComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._loadingComponent);
...
/* harmony import */ var _view_navigation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/navigation.js */ "./src/view/navigation.js");
...
const {AFTERBEGIN} = _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"];
const {MAJOR} = _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"];
const {MOVIES, STATISTICS} = _const_js__WEBPACK_IMPORTED_MODULE_4__["NavigationMode"];
const {ALL, STATS} = _const_js__WEBPACK_IMPORTED_MODULE_4__["MenuItem"];
...
class Navigation {
  ...
  init() {
    ...
    this._navigationComponent = new _view_navigation_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentMenuItem);
    this._navigationComponent.setMenuChangeHandler(this._handleMenuChange);

    if (prevNavigationComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._navigationContainer, this._navigationComponent, AFTERBEGIN);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(prevNavigationComponent, this._navigationComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevNavigationComponent);
  }
    ...
    switch (this._navigationMode) {
      case MOVIES:
        if (menuItem === STATS) {
          ...
          this._statisticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._moviesModel.getWatchedMovies());
          Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(this._navigationContainer, this._statisticsComponent);
          this.init();
        ...
        break;
      case STATISTICS:
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._statisticsComponent);
  ...
  _getFilters() {
    ...
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_2__["getFiltersCount"])(movies);
  }
}
...
class Profile {
  ...
  init() {
    ...
    const rank = Object(_utils_profile_js__WEBPACK_IMPORTED_MODULE_1__["getRank"])(watchedFilmsCount);

    const prevProfileComponent = this._profileComponent;
    this._profileComponent = new _view_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](rank);

    if (prevProfileComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._profileContainer, this._profileComponent);
      return;
    }
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(prevProfileComponent, this._profileComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevProfileComponent);
  }
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: formatDuration, formatDate, humanizeCommentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "humanizeCommentDate", function() { return humanizeCommentDate; });
...
const formatDate = (date, isFullDate) => {
  return isFullDate ? moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`DD MMMM YYYY`) : moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY`);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: filterRules, getFiltersCount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterRules", function() { return filterRules; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFiltersCount", function() { return getFiltersCount; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./src/const.js");

const {ALL, WATCHLIST, HISTORY, FAVORITES} = _const_js__WEBPACK_IMPORTED_MODULE_0__["MenuItem"];
...
/*!******************************!*\
  !*** ./src/utils/sorting.js ***!
  \******************************/
/*! exports provided: sortByRating, sortByCommentsCount, sortByDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortByRating", function() { return sortByRating; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortByCommentsCount", function() { return sortByCommentsCount; });
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: Range, getFilmsInRange, getTotalDuration, getGenresCount, getTopGenre */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Range", function() { return Range; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsInRange", function() { return getFilmsInRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getTotalDuration", function() { return getTotalDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenresCount", function() { return getGenresCount; });
...
const getFilmsInRange = (films, range) => {
  if (range === ALLTIME.value) {
    return films;
  }

  const startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(range);

  return films.filter((film) => moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchedDate).isSame(startDate, `day`) || moment__WEBPACK_IMPORTED_MODULE_0___default()(film.watchedDate).isAfter(startDate));
};
...
class AllMovies extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createCommentMarkup = (data) => {
  ...
  const date = Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["humanizeCommentDate"])(day);
...
/*!******************************!*\
  !*** ./src/view/comments.js ***!
  \******************************/
/*! exports provided: createCommentsMarkup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createCommentsMarkup", function() { return createCommentsMarkup; });
...
const createEmojiListMarkup = (emojiName) => {
  ...
  return _const_js__WEBPACK_IMPORTED_MODULE_1__["EMOJIS"].map((emoji) =>
...
const createCommentsMarkup = (comments, isEmoji, emojiName, text, isDisabled) => {
  ...
  <div class="film-details__new-comment">
    ...
    <label class="film-details__comment-label">
      ...
      name="comment" ${isDisabled ? `disabled` : ``}>${he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(text)}</textarea>
    </label>
...
const createFilmCardMarkup = (film) => {
  ...
  return (
    ...
    <p class="film-card__info">
      <span class="film-card__year">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date)}</span>
...
class Films extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class MostCommented extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const {ALL, WATCHLIST, HISTORY, FAVORITES, STATS} = _const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"];
...
/* harmony import */ var _smart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./smart.js */ "./src/view/smart.js");
/* harmony import */ var _utils_film_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/film.js */ "./src/utils/film.js");
/* harmony import */ var _comments_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./comments.js */ "./src/view/comments.js");
...
const createFilmDetailsMarkup = (film) => {
  ...
  <tr class="film-details__row">
    ...
    <td class="film-details__cell">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(date, true)}</td>
  </tr>
  <tr class="film-details__row">
    <td class="film-details__term">Runtime</td>
    <td class="film-details__cell">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(duration)}</td>
  </tr>
  <tr class="film-details__row">
...
const createPopUpMarkup = (data) => {
  ...
  const commentsMarkup = Object(_comments_js__WEBPACK_IMPORTED_MODULE_2__["createCommentsMarkup"])(comments, isEmoji, emojiName, text, isDisabled);
...
class ShowButton extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
const {DEFAULT, DATE, RATING} = _const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"];
...
/* harmony import */ var _utils_profile_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/profile.js */ "./src/utils/profile.js");
...
const {ALLTIME} = _utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["Range"];
const BAR_HEIGHT = 50;

const renderGenresChart = (statisticCtx, films, currentRange) => {

  const filmsInRange = films.length !== 0 ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getFilmsInRange"])(films, currentRange) : [];

  if (filmsInRange.length === 0) {
    statisticCtx.classList.add(`visually-hidden`);
  }
  const genresCount = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getGenresCount"])(filmsInRange);
...
const createStatisticFiltersMarkup = (currentRange) => {
  ...
  return Object.values(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["Range"]).map((range) =>
...
const createStatisticsMarkup = (data) => {
  ...
  const rank = films.length !== 0 ? Object(_utils_profile_js__WEBPACK_IMPORTED_MODULE_5__["getRank"])(films.length) : ``;
  const filmsInRange = films.length !== 0 ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getFilmsInRange"])(films, currentRange) : [];
  const totalDuration = filmsInRange.length !== 0 ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getTotalDuration"])(filmsInRange) : 0;
  const totalHours = totalDuration !== 0 ? Math.floor(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(totalDuration, `minutes`).asHours()) : 0;
  const totalMinutes = totalDuration !== 0 ? moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(totalDuration, `minutes`).minutes() : 0;
  const genresCount = filmsInRange.length !== 0 ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getGenresCount"])(filmsInRange) : 0;
  const topGenre = genresCount !== 0 ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_4__["getTopGenre"])(genresCount) : ``;
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_3__["default"] {
  constructor(films) {
    super();
    this._data = {
      films,
...
class Total extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    super();
    this._films = films;
  }
